...
public class GridIntelligenceSettings : ScriptableObject {
	...
	#if UNITY_EDITOR
	[MenuItem("Assets/Create/GridIntelligenceSettings")]
	public static void CreateAsset ()
	{
		ScriptableObjectUtility.CreateAsset<GridIntelligenceSettings> ();
	}
	#endif		
}
